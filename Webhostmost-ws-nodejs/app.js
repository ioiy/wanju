...
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';   // 哪吒域名
...
const NAME = process.env.NAME || 'heliohost';
...
function getFilesForArchitecture(architecture) {
  if (architecture === 'arm') {
    return [
      { fileName: "npm", fileUrl: "https://github.com/ioiy/nezha-v0.20.5/releases/download/nezha/nezha-agent_arm64" },
    ];
  } else if (architecture === 'amd') {
    return [
      { fileName: "npm", fileUrl: "https://github.com/ioiy/nezha-v0.20.5/releases/download/nezha/nezha-agent_amd64" },
    ];
  }
  return [];
}
